...
const allSabores = [
    ...
    { id: 2,  nombre: "Acelga con Salsa Blanca",       descripcion: "Muzzarella y Acelga con salsa blanca cremosa.",            imagen: "acelga",            tipo: "sabor" },
    { id: 3,  nombre: "Anchoas",                       descripcion: "Muzzarella y triturado de tomate y anchoa.",                      imagen: "anchoas",           tipo: "sabor" },
    { id: 4,  nombre: "Atún",                          descripcion: "Muzzarella y atún.",                                   imagen: "atun",              tipo: "sabor" },
    { id: 5,  nombre: "Berenjenas",                    descripcion: "Muzzarella y berenjenas grilladas.",                   imagen: "berenjenas",        tipo: "sabor" },
    { id: 6,  nombre: "Bolognesa",                     descripcion: "Muzzarella y salsa bolognesa con provolone.",                        imagen: "bolognesa",         tipo: "sabor" },
    ...
    { id: 10, nombre: "Cebolla de Verdeo a la Crema",  descripcion: "Muzzarella y Cebolla de verdeo con un toque de crema.",             imagen: "cebolla_verdeo_crema", tipo: "sabor" },
    ...
    { id: 15, nombre: "Fugazzeta a la Crema",          descripcion: "Muzzarella y Fugazzeta con un toque de crema.",                     imagen: "fugazzeta_crema",   tipo: "sabor" },
    ...
    { id: 20, nombre: "Jamón y Morrón",                descripcion: "Muzzarella, jamón y morrón.",            imagen: "jamon_morron",      tipo: "sabor" },
    { id: 21, nombre: "Muzzarella",                    descripcion: "Clasica muzzarella.",                        imagen: "muzzarella",        tipo: "sabor" },
    { id: 22, nombre: "Napolitana",                    descripcion: "Muzzarella, jamón y tomate.",                 imagen: "napolitana",        tipo: "sabor" },
    { id: 23, nombre: "Palmitos",                      descripcion: "Muzzarella y palmitos.",                               imagen: "palmitos",          tipo: "sabor" },
    ...
    { id: 26, nombre: "Pollo",                         descripcion: "Muzzarella y pollo.",                                  imagen: "pollo",             tipo: "sabor" },
    { id: 27, nombre: "Pollo a la Mostaza",            descripcion: "Muzzarella, pollo y salsa de mostaza.",                imagen: "pollo_mostaza",     tipo: "sabor" },
    { id: 28, nombre: "Provenzal",                     descripcion: "Muzzarella y Tomate con ajo y perejil.",                        imagen: "provenzal",         tipo: "sabor" },
    ...
    { id: 34, nombre: "Salsa Criolla",                 descripcion: "Muzzarella con salsa criolla (morrón, cebolla y tomate).", imagen: "salsa_criolla",  tipo: "sabor" },
    { id: 35, nombre: "Salsa Mixta",                   descripcion: "Muzzarella con salsa de tomate y salsa blanca.",                          imagen: "salsa_mixta",       tipo: "sabor" }, // ⚠️ revisar receta exacta
    { id: 36, nombre: "Tomate y Albahaca",             descripcion: "Muzzarella con Tomate y albahaca.",                imagen: "tomate_albahaca",   tipo: "sabor" },
    { id: 37, nombre: "Tropical",                      descripcion: "Muzzarella con jamón, huevo, morrón y aceitunas.",     imagen: "tropical",          tipo: "sabor" }, // ⚠️ revisar receta exacta (¿se superpone con Jamón y Ananá?)
];
